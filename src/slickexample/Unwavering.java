...
public class Unwavering extends BasicGameState {
	...
	public ItemWin antidote;
        ...
        public Enemy Messi,Pele,Neymar,Suarez,Ricardo,Iggy,Nacho,Frijoles,Queso,Taco,Pastor,Cristiano,
        Chicharito,Bele,James,Pique,Carne,Memes;
	...
	throws SlickException {
		...
		SpriteSheet runningSS = new SpriteSheet(
				"res/Guajardo_Character.png",64, 64, 0);
		...
		stuff.add(healthpotion1);
                ...
                /*Pele = new Enemy(1016,1621);
                Neymar = new Enemy(723,3315);
                Suarez = new Enemy(2078,3619);
                Iggy = new Enemy(2938,3619);
                Nacho = new Enemy(5184,4889);
                Frijoles = new Enemy(3887,5203);
                Queso = new Enemy(6567,2789);
                Taco = new Enemy(6460,1861);
                Pastor = new Enemy(5674,2173);
                Cristiano = new Enemy(5672,2503);
                Chicharito = new Enemy(3754,409);
                Bele = new Enemy(2138,426);
                James = new Enemy(4697,1177);
                Pique = new Enemy(7022,102);
                Carne = new Enemy(6793,1012);
                */ Memes= new Enemy(5882,1230);
                ...
                enemiez.add(Iggy);
                enemiez.add(Nacho);
                enemiez.add(Frijoles);
                enemiez.add(Queso);
                enemiez.add(Taco);
                enemiez.add(Pastor);
                enemiez.add(Cristiano);
                enemiez.add(Chicharito);
                enemiez.add(Bele);
                enemiez.add(James);
                enemiez.add(Pique);
                enemiez.add(Carne);
